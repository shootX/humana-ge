                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="text-end mb-1">
                                        <button class="btn btn-sm btn-primary" data-repeater-create type="button"
                                            data-bs-toggle="tooltip" title="{{ __('Add logo') }}"><i
                                                ...
                                                <div class="card mb-3 border shadow-none product_Image">
                                                    <div class="px-2 py-2">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                <a class="action-item btn btn-sm btn-danger delete-button text-white"
                                                                    data-image="{{ $home_logo }}" data-bs-toggle="tooltip" title="{{ __('Delete') }}">
                                                                    <i class="ti ti-trash"></i>
                                                                </a>
                                                            </div>
                                                        </div>
