...
class ProjectReportController extends Controller
{
    ...
    public function ajax_data(Request $request, $slug)
    {
        ...
        foreach ($projects as $project) {
            ...
            $images_path = Utility::get_file('avatars/');
            ...
            if (Auth::user()->getGuard() != 'client') {
                ...
                $tmp['action'] = '
                <a  class="btn-warning  btn btn-sm me-1" data-toggle="tooltip"  title="' . __('Show Project Report') . '" data-size="lg" data-title="' . __('show') . '" href="' . route(
                ...
                <a href="#" class="btn-info  btn btn-sm" data-toggle="tooltip"  title="' . __('Edit Project') . '" data-ajax-popup="true" data-size="lg" data-title="' . __('Edit') . '" data-url="' . route(
                    'projects.edit',
                    [
                        $currentWorkspace->slug,
                        $project->id,
                ...
                $tmp['action'] = '
                <a  class="btn-warning  btn btn-sm" data-toggle="tooltip"  title="' . __('Show Project Report') . '" data-size="lg" data-title="' . __('show') . '" href="' . route(
                    $client_keyword . 'project_report.show',
                    [
                        $currentWorkspace->slug,
                        $project->id,
