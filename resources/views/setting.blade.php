                                        ...
                                        <div class="row mt-2">
                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img src="{{ asset('storage/logo/logo-light.png') }}"
                                                                id="dark_logo"
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img src="{{ asset('storage/logo/logo-dark.png') }}"
                                                                id="image"
                                                                style="filter: drop-shadow(2px 3px 7px #011c4b);"
                                                                class="small_logo" />
                                                        </div>
                                            ...
                                            <div class="col-sm-6 col-md-4">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="logo-content">
                                                            <img src="{{ asset('storage/logo/favicon.png') }}"
                                        ...
                                        <div class="row ">
                                            <div class="col-12 row">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    ...
                                                    {{-- <div class="card-body"> --}}
                                                    <div class="logo-content">
                                                        <img src="@if ($setting['meta_image']) {{ asset('storage/logo/' . $setting['meta_image']) }} @else{{ asset('storage/logo/meta_image.png') }} @endif"
                                                            class="col-9" id="meta" />
                                                    </div>
                                                    <div class="choose-file mt-5 ">
