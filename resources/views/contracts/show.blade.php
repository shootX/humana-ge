...
@section('links')
    ...
    @if (\Auth::guard('client')->check())
        <li class="breadcrumb-item">
            <a href="{{ route($client_keyword . 'contracts.index', $currentWorkspace->slug) }}">{{ __('Contracts') }}</a>
        </li>
    @else
        <li class="breadcrumb-item">
            <a href="{{ route($client_keyword . 'contracts.index', $currentWorkspace->slug) }}">{{ __('Contracts') }}</a>
            ...
            @if ($contract->status == 'accept' || $currentWorkspace->permission == 'Owner')
                <div class="col-auto pe-0 px-2">
                    <a href="#" class="btn btn-sm btn-primary btn-icon"
                        ...
                        data-ajax-popup="true" data-title="{{ __('Add Signature') }}" data-size="md"
                    ...
                    <li class="dropdown dash-h-item drp-language">
                        <a class="dash-head-link dropdown-toggle arrow-none me-0 ms-0 p-2 rounded-1"
                            ...
                            <span class="drp-text hide-mob">
                                <i class=" drp-arrow nocolor hide-mob">{{ ucfirst($contract->status) }}
                                    <span class="ti ti-chevron-down px-1"></span>
                                </i>
                            </span>
                        </a>
                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#attachments"
                                class="list-group-item list-group-item-action border-0 ">{{ __('Attachment') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>

                            <a href="#comment"
                                class="list-group-item list-group-item-action border-0">{{ __('Comment') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                                                    ...
                                                    <div class="card mb-3 border shadow-none">
                                                        <div class="px-3 py-3">
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="p-0 w-auto me-2">
                                                                    <a href="{{ asset(Storage::url('contract_attechment')) . '/' . $file->files }}"
                                                                        class="btn btn-sm btn-warning" download=""
                                                    ...
                                                    <div class="form-group mb-0 form-send w-100">
                                                        <form method="post" class="card-comment-box needs-validation"
                                                            ...
                                                            <grammarly-extension data-grammarly-shadow-root="true"
                                                                ...
                                                                class="cGcvT"></grammarly-extension>
                                                            <button id="" type="submit" class="btn btn-send">
                                                                ...
                                                                <div class="col-auto">
                                                                    <a href="#"
                                                                        ...
                                                                        <img class="avatar-sm rounded-circle img-thumbnail"
                                                                            ...
                                                                            @if ($comment->user_id != '' && $comment->user_id != null) @if ($comment->user->avatar) src="{{ asset('/storage/avatars/' . $comment->user->avatar) }}"
                                                                                @else avatar="{{ $comment->user->name }}" @endif
                                                                        alt="{{ $comment->user->name }}" @else
                                                                            @if ($comment->client->avatar) src="{{ asset('/storage/avatars/' . $comment->client->avatar) }}"
                                                                                @else avatar="{{ $comment->client->name }}" @endif
                                                            ...
                                                            <div class="col-auto">
                                                                <a href="#"
                                                                    ...
                                                                    <img class="avatar-sm rounded-circle img-thumbnail"
                                                                        width=""
                                                                        style="max-width: 30px; max-height: 30px;"
                                                                        @if ($note->user_id != '' && $note->user_id != null) @if ($note->user->avatar) src="{{ asset('/storage/avatars/' . $note->user->avatar) }}"
                                                                            @else avatar="{{ $note->user->name }}" @endif
                                                                    alt="{{ $note->user->name }}" @else
                                                                        @if ($note->client->avatar) src="{{ asset('/storage/avatars/' . $note->client->avatar) }}"
                                                                            @else avatar="{{ $note->client->name }}" @endif
...
@push('scripts')
    ...
    <script>
        ...
        function dropzoneBtn(file, response) {
            ...
            download.setAttribute('class', "btn-primary mx-1 mt-1 btn btn-sm");
            ...
            del.setAttribute('class', "btn-danger mx-1 mt-1 btn btn-sm");
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var html = "<div class='list-group-item px-0'>" +
                            ...
                            "</small>" +
                            "                        </div>" +
                            "                        <div class='bg-danger me-4'><div class='col-auto'><a href='#' class='mx-3 btn btn-sm  align-items-center delete-comment' data-url='" +
                            data.deleteUrl +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var html = "<div class='list-group-item px-0'>" +
                            ...
                            "</small>" +
                            "                        </div>" +
                            "                        <div class='bg-danger me-4'><div class='col-auto'><a href='#' class='mx-3 btn btn-sm  align-items-center delete-note' data-url='" +
                            data.deleteUrl +
                            "'><i class='ti ti-trash text-white'></i></a></div></div>" +
                            "                    </div>" +
                            "                </div>";
