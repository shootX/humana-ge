                ...
                <div class="d-block d-sm-flex align-items-center justify-content-end">
                    <div class="col-auto pe-0">
                        <a href="{{ route('contract.download.pdf', [$currentWorkspace->slug, \Crypt::encrypt($contract->id)]) }}"
                            ...
                            title="{{ __('Download') }}"><i class="ti ti-download"></i> {{ __('Download') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="">
                        <div class="col-auto pe-0 mb-3 ">
                            <img src="{{ asset($logo . $company_logo) }}" style="max-width: 150px;" />
                        </div>
                    </div>
                    <div class="row align-items-center mb-4">
                        <div class="col-sm-6 mb-3 mb-sm-0 mt-3">
                            <div class="col-lg-6 col-md-8">
                                ...
                                <span class="col-md-8">
                                    <span class="text-md">{{ $currentWorkspace->priceFormat($contract->value) }}</span>
                                </span>
                            </div>
                            <div class="col-lg-6 col-md-8 mt-3">
                                ...
                                <span class="col-md-8">
                                    <span
                                        class="text-md">{{ App\Models\Utility::contractNumberFormat($contract->id) }}</span>
                                </span>
                            </div>
                            <div class="col-lg-6 col-md-8 mt-3">
                                <h6 class="d-inline-block m-0 d-print-none">{{ __('Contract Type  :') }}</h6>
                                <span class="col-md-8">
                                    <span class="text-md">{{ $contract->contract_type->name }}</span>
                                </span>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="float-end">
                                    <div class="">
                                        ...
                                        <span class="col-md-8">
                                            <span
                                                class="text-md">{{ App\Models\Utility::dateFormat($contract->start_date) }}</span>
                                        </span>
                                    </div>
                                    <div class="mt-3">
                                        ...
                                        <span class="col-md-8">
                                            <span
                                                class="text-md">{{ App\Models\Utility::dateFormat($contract->end_date) }}</span>
                                        </span>
                                    </div>
                                </div>
                            </div>
