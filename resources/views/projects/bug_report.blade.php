                                    ...
                                    <div class="card-header">
                                        <div class="float-end">
                                            <button class="btn-submit btn btn-md btn-primary btn-icon px-1  py-0">
                                                <span
                                                    class="badge badge-secondary count">{{ $stage->bugs->count() }}</span>
                                            </button>
                                        </div>
                                            ...
                                            <div class="card" id="{{ $bug->id }}">
                                                ...
                                                <div class="position-absolute top-0 start-0 pt-3 ps-3">
                                                    ...
                                                    @elseif($bug->priority == 'High')
                                                        <div class="badge bg-danger p-2 px-3"> {{ $bug->priority }}
                                                        </div>
                                                    @endif
                                                </div>
                        ...
                        success: function(data) {
                            ...
                            if (data.user_type == 'Client') {
                                ...
                                var html = "<li class='media border-bottom mb-3'>" +
                                    ...
                                    "                               <a href='#' class='delete-icon delete-comment btn-danger  btn btn-sm' data-url='" +
                                    data.deleteUrl + "'>" +
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.deleteUrl.length > 0) {
                            delLink =
                                "<a href='#' class='delete-icon delete-comment-file btn-danger  btn btn-sm mx-1'  data-url='" +
                                data.deleteUrl + "'>" +
                                "                                        <i class='ti ti-trash'></i>" +
                                "                                    </a>";
                        }
