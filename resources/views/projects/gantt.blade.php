...
@section('action-button')
    <div class="btn-group flex-wrap normal-gap" id="change_view" role="group">
        <div class="gantt-nav-wrp d-flex  bg-info">
        ...
        @auth('client')
            <a href="{{ route('client.projects.show', [$currentWorkspace->slug, $project->id]) }}"
                class="btn btn-sm btn-primary" data-toggle="tooltip" title="{{ __('Back') }}">
                <i class=" ti ti-arrow-back-up"></i>
            </a>
            @elseauth
            <div class="col-auto">
                <a href="{{ route('projects.show', [$currentWorkspace->slug, $project->id]) }}" class="btn btn-sm btn-primary"
