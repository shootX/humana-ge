@if ($timesheet && $currentWorkspace)
    <form class="needs-validation" novalidate method="post"
        action="{{ route('timesheet.update', [$currentWorkspace->slug, $timesheet->id]) }}">
        @csrf
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control form-control-light" name="task_id" id="task_id" required
                    data-selected="{{ $timesheet->task_id }}">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control form-control-light date" id="date"
                    value="{{ $timesheet->date }}" placeholder="{{ __('Date') }}" name="date" required>
            </div>
            <div class="form-group">
                ...
                <input type="time" class="form-control form-control-light" id="time"
                    value="{{ $timesheet->time }}" placeholder="{{ __('Time') }}" name="time" required>
            </div>
            <div class="form-group">
