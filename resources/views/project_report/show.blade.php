...
@section('links')
    ...
    @if (\Auth::guard('client')->check())
        <li class="breadcrumb-item">
            <a href="{{ route('client.project_report.index', $currentWorkspace->slug) }}">{{ __('Project Report') }}</a>
        </li>
    @else
        <li class="breadcrumb-item">
            <a href="{{ route('project_report.index', $currentWorkspace->slug) }}">{{ __('Project Report') }}</a>
        </li>
    @endif
...
@section('action-button')
    <a href="#" onclick="saveAsPDF()" class="btn btn-sm btn-primary" data-toggle="tooltip"
        ...
        <div class="col-sm-12">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-12 mt-3 mb-3 row d-sm-flex align-items-center justify-content-end" id="show_filter">
                        ...
                        <div class="col-sm-6 col-md-2">
                            ...
                            <a href="{{ route($client_keyword . 'project_report.export', $project->id) }}"
                                class="btn btn-sm btn-primary" data-toggle="tooltip" title="{{ __('Export') }}">
